-- Fix validation RLS: ambiguous `id` bound to assignment id; clients could not read assignments.
-- Use security definer helpers to avoid infinite recursion between requests and assignments.
